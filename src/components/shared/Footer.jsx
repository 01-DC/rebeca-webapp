		...
		<>
			<footer className="footer p-16 pb-12 bg-neutral text-base-content">
				...
				<div>
					...
					<Link to="/workshops" className="link link-hover">
						Workshops
					</Link>
				...
				<div>
					...
					<div className="flex items-center justify-center gap-4">
						...
						<a
							href="https://play.google.com/store/apps/details?id=com.appdev.abhishek360.instruo"
							target="_blank">
							<svg
								className="fill-current"
								width="28"
